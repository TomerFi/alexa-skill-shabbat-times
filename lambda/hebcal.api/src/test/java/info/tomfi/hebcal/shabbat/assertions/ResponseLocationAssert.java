...
public final class ResponseLocationAssert extends AbstractAssert<ResponseLocationAssert, ResponseLocation> {
  ...
  public ResponseLocationAssert asciinameIs(final String testAsciiname) {
    ...
    if (!actual.asciiname().equals(testAsciiname)) {
      failWithMessage("Expected asciiname to be <%s> but was <%s>", testAsciiname, actual.asciiname());
    }
    return this;
  }
  ...
  public ResponseLocationAssert geonameidIs(final int testGeonameid) {
    ...
    if (actual.geonameid() != testGeonameid) {
      failWithMessage("Expected geonameid to be <%s> but was <%s>", testGeonameid, actual.geonameid());
    }
    return this;
  }
  ...
  public ResponseLocationAssert longitudeIs(final Double testLongitude) {
    ...
    if (!actual.longitude().equals(testLongitude)) {
      failWithMessage("Expected longitude to be <%s> but was <%s>", testLongitude, actual.longitude());
    }
    return this;
  }
}
