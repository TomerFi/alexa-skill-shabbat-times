...
import static info.tomfi.shabbattimes.skill.tools.SkillTools.getCitySlotFromMap;
...
public final class SkillToolsTest {
  ...
  public void getCitySlotFromMap_noValues_throwsException() {
    assertThatExceptionOfType(NoCitySlotException.class)
        .isThrownBy(() -> getCitySlotFromMap(slots));
  }
