...
public final class StopIntentHandlerTest {
  private static IntentRequest fakeRequest;
  private static HandlerInput fakeInput;

  private static StopIntentHandler handlerInTest;

  @BeforeAll
  public static void initialize() {
    final Intent fakeIntent = Intent.builder().withName(STOP.getName()).build();
    ...
    handlerInTest = new StopIntentHandler();
  }
