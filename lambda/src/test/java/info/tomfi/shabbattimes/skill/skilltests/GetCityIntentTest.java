...
import info.tomfi.shabbattimes.skill.di.DiBreakApiConfiguration;
...
public final class GetCityIntentTest {
  ...
  public void testGetCityIntent_Tuesday_IsraelCity_NoCountry()
    ...
    assertThat(response)
        ...
        .outputSpeechIs(
            "Shabbat times in Rishon LeẔiyyon: starts on friday. 2019-10-04, at 18:04. and ends on saturday. 2019-10-05, at 19:11.Would you like me to get the Shabbat times in another city?")
        .repromptSpeechIs(
            "If you're interested in another city, please tell me the city name. For a list of all the possible city names, just ask me for help.");
  }
  ...
  public void testGetCityIntent_Thursday_IsraelCity_NoCountry()
    ...
    assertThat(response)
        ...
        .sessionAttributesHasKeyWithValue("lastIntent", "GetCityIntent")
        .outputSpeechIs(
            "Shabbat times in Rishon LeẔiyyon: starts tomorrow. 2019-10-04, at 18:04. and ends on saturday. 2019-10-05, at 19:11.Would you like me to get the Shabbat times in another city?")
        .repromptSpeechIs(
            "If you're interested in another city, please tell me the city name. For a list of all the possible city names, just ask me for help.");
  }
  ...
  public void testGetCityIntent_Friday_IsraelCity_NoCountry()
    ...
    assertThat(response)
        ...
        .sessionAttributesHasKeyWithValue("lastIntent", "GetCityIntent")
        .outputSpeechIs(
            "Shabbat times in Rishon LeẔiyyon: starts today. 2019-10-04, at 18:04. and ends tomorrow. 2019-10-05, at 19:11.Would you like me to get the Shabbat times in another city?")
        .repromptSpeechIs(
            "If you're interested in another city, please tell me the city name. For a list of all the possible city names, just ask me for help.");
  }
  ...
  public void testGetCityIntent_Saturday_IsraelCity_NoCountry()
    ...
    assertThat(response)
        ...
        .sessionAttributesHasKeyWithValue("lastIntent", "GetCityIntent")
        .outputSpeechIs(
            "Shabbat times in Rishon LeẔiyyon: started yesterday. 2019-10-04, at 18:04. and ends today. 2019-10-05, at 19:11.Would you like me to get the Shabbat times in another city?")
        .repromptSpeechIs(
            "If you're interested in another city, please tell me the city name. For a list of all the possible city names, just ask me for help.");
  }
  ...
  public void testGetCityIntent_unknownCityNoCountry() throws IOException, URISyntaxException {
    ...
    assertThat(response)
        ...
        .outputSpeechIs(
            "I'm sorry. I can't seem to find your requested city. Please repeat the city name. For a list of all the possible city names, just ask me for help.")
        .repromptSpeechIs(
