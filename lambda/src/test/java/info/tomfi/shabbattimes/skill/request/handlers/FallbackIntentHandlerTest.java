...
import static info.tomfi.shabbattimes.skill.enums.Intents.FALLBACK;
...
public final class FallbackIntentHandlerTest {
  ...
  private static FallbackIntentHandler handlerInTest;

  @BeforeAll
  public static void initialize() {
    final Intent fakeIntent = Intent.builder().withName(FALLBACK.getName()).build();
    ...
    handlerInTest = new FallbackIntentHandler();
  }
