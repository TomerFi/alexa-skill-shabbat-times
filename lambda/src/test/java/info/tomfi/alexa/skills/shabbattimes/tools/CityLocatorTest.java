...
public final class CityLocatorTest {
  ...
  @Test
  @DisplayName(
      "test exception thrown when trying to locate a non-existing city with a correct country")
  public void getByCityAndCountry_getUnknownCityWithCountry_throwsExcption() {
    ...
    assertThatExceptionOfType(NoCityInCountryException.class)
        .isThrownBy(() -> CityLocator.getByCityAndCountry(countrySlot, citySlot));
  }
  ...
  public void getByCityAndCountry_getUnknownCityWithoutCountry_throwsExcption() {
    when(citySlot.getValue()).thenReturn("unknown city");
    assertThatExceptionOfType(NoCityFoundException.class)
        .isThrownBy(() -> CityLocator.getByCityAndCountry(countrySlot, citySlot));
  }
  ...
  @Test
  @DisplayName(
      "test the retrieval of a city in united states with selecting the united states as the country")
  ...
  @Test
  @DisplayName(
      "test the retrieval of a city in united kingdom with selecting the united kingdom as the country")
