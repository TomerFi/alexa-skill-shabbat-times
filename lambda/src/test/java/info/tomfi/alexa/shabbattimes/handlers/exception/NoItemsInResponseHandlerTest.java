...
/** Test cases for the NoItemsInResponseHandler exception handler. */
@Tag("unit-tests")
final class NoItemsInResponseHandlerTest extends HandlerFixtures {
  @InjectMocks private NoItemsInResponseHandler sut;
  ...
  @Test
  void can_handle_should_return_false_for_exception_other_then_of_no_items_in_response_exception() {
