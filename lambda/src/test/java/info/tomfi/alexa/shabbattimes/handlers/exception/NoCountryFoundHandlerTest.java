...
/** Test cases for the NoCountryFoundHandler exception handler. */
@Tag("unit-tests")
final class NoCountryFoundHandlerTest extends HandlerFixtures {
  @InjectMocks private NoCountryFoundHandler sut;

  @Test
  void can_handle_should_return_true_only_for_instances_of_no_country_found_exception() {
    assertThat(sut.canHandle(input, new NoCountryFoundException())).isTrue();
  }

  @Test
  void can_handle_should_return_false_for_exception_other_then_of_no_country_found_exception() {
