...
import info.tomfi.hebcal.api.enums.FlagStates;
import info.tomfi.hebcal.api.enums.GeoTypes;
import info.tomfi.hebcal.api.enums.OutputTypes;
import info.tomfi.hebcal.api.enums.ParamKeys;
...
public final class ApiRequestMaker {
   ...
   *
   * <p>Default mintues if not set is {@linkplain #DEFAULT_HAVDALAH}.
   *
  ...
  /**
   * Set the the minutes before sundown of the shabbat start for calculation of the shabbat start
   * time.
   *
   * <p>Default mintues if not set is {@linkplain #DEFAULT_CANDLE_LIGHTING}.
   *
   * @param minutes integer representing the minutes to set.
   * @return this builder object.
   ...
   *
   * @return the {@link info.tomfi.hebcal.api.response.ApiResponse} represnting
   *     the response consumed from the api.
