...
import static info.tomfi.shabbattimes.skill.enums.BundleKeys.THANKS_AND_BYE;
import static info.tomfi.shabbattimes.skill.enums.Intents.THANKS;
 ...
 * {#value info.tomfi.shabbattimes.skill.enums.Intents.THANKS} intent requests.
 *
...
public final class ThanksIntentHandler implements IntentRequestHandler {
  ...
  public Optional<Response> handle(final HandlerInput input, final IntentRequest intent) {
    return input
        .getResponseBuilder()
        .withSpeech(
            getFromBundle(input.getAttributesManager().getRequestAttributes(), THANKS_AND_BYE))
