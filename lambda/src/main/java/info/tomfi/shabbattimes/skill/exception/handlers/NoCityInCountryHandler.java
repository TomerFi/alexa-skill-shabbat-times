...
import static info.tomfi.shabbattimes.skill.enums.BundleKeys.EXC_NO_CITY_FOUND;
 ...
 * info.tomfi.shabbattimes.skill.exception.NoCityInCountryException} exceptions.
 *
 * @author Tomer Figenblat {@literal <tomer.figenblat@gmail.com>}
 */
@Component
public final class NoCityInCountryHandler implements ExceptionHandler {
  public NoCityInCountryHandler() {
    //
  }
