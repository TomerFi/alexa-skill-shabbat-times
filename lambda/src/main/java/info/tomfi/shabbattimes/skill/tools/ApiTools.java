...
public final class ApiTools {
   ...
   * info.tomfi.hebcal.api.response.items.ResponseItem} list to its {@linkplain
   * info.tomfi.hebcal.api.enums.ItemCategories#HAVDALAH} and {@linkplain
   * info.tomfi.hebcal.api.enums.ItemCategories#CANDLES} items only.
   *
   * @param response the original {@link
   *     info.tomfi.hebcal.api.response.ApiResponse} object.
   ...
   * info.tomfi.hebcal.api.enums.ItemCategories#CANDLES} item for a specific
   * date.
   *
   * @param items a list of {@link
   *     info.tomfi.hebcal.api.response.items.ResponseItem}.
   ...
   *     info.tomfi.hebcal.api.response.items.ResponseItem} corresponding to the
   *     requested date.
   */
  ...
  /**
   * A static tool for retrieving the {@linkplain
   * info.tomfi.hebcal.api.enums.ItemCategories#HAVDALAH} item for a specific
   * date.
   *
   * @param items a list of {@link
   *     info.tomfi.hebcal.api.response.items.ResponseItem}.
