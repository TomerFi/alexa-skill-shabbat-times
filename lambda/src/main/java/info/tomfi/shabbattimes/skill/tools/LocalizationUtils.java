...
public final class LocalizationUtils {
   ...
   *     info.tomfi.shabbattimes.skill.enums.Attributes#L10N_BUNDLE}.
   * @param key a {@link info.tomfi.shabbattimes.skill.enums.BundleKeys} member corresponding
   *     to the locale properties file key.
   ...
   *     {@linkplain info.tomfi.shabbattimes.skill.enums.Attributes#L10N_BUNDLE}.
  ...
  public static String getStartsAtPresentation(
    ...
    return getFromBundle(
        ...
        dow.equals(DayOfWeek.THURSDAY)
            ? BundleKeys.SHABBAT_START_TOMORROW
            : dow.equals(DayOfWeek.FRIDAY)
                ? BundleKeys.SHABBAT_START_TODAY
                : dow.equals(DayOfWeek.SATURDAY)
                    ? BundleKeys.SHABBAT_START_YESTERDAY
  ...
  public static String getEndsAtPresentation(
    ...
    return getFromBundle(
        requestAttributes,
        dow.equals(DayOfWeek.FRIDAY)
            ? BundleKeys.SHABBAT_END_TOMORROW
            : dow.equals(DayOfWeek.SATURDAY)
                ? BundleKeys.SHABBAT_END_TODAY
