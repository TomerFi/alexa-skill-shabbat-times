...
/** Exception handler used for handling {@link NoItemsInResponseException} cases. */
@Component
public final class NoItemsInResponseHandler implements ExceptionHandler {
  private final TextService textor;

  public NoItemsInResponseHandler(final TextService setTextor) {
    textor = setTextor;
  }

  @Override
  public boolean canHandle(final HandlerInput input, final Throwable throwable) {
    return throwable instanceof NoItemsInResponseException;
  }
