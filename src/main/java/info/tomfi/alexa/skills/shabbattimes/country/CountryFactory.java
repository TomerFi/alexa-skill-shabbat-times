...
public final class CountryFactory
{
    ...
    /**
     * Factory for creating a {@link info.tomfi.alexa.skills.shabbattimes.country.Country}
     * object from a String country name.
     *
     * The country names are being validated and constructed using the enum class
     * {@link info.tomfi.alexa.skills.shabbattimes.enums.CountryInfo}.
     *
     ...
     * @throws UnknownCountryException when the country requested is not found within the
     *     {@link info.tomfi.alexa.skills.shabbattimes.enums.CountryInfo} enum members.
     */
    @Synchronized
    ...
    /**
     * Factory for creating a {@link info.tomfi.alexa.skills.shabbattimes.country.Country} object
     * from a {@link info.tomfi.alexa.skills.shabbattimes.enums.CountryInfo} member.
     *
