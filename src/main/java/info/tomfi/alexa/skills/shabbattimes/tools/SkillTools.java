...
public final class SkillTools
{
    ...
    /**
     * A static tool for retrieving the {@link info.tomfi.alexa.skills.shabbattimes.city.City}
     * object from the slots map and saving the appropriate information as session attributes.
     *
     * @param slots the map of slots retrieved from the request.
