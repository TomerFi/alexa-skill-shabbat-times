...
public final class ApiTools {
   ...
   * info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#HAVDALAH} and {@linkplain
   * info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#CANDLES} items only.
   *
   * @param response the original {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.ApiResponse} object.
   * @return a sorted by date list of {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.items.ResponseItem} objects.
   */
   ...
   * info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#CANDLES} item for a specific
   * date.
   *
   * @param items a list of {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.items.ResponseItem}.
   * @param shabbatDate the date object for looking up the {@linkplain
   *     info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#CANDLES} item.
   * @return an Optional {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.items.ResponseItem} corresponding to the
   *     requested date.
   */
  ...
  /**
   * A static tool for retrieving the {@linkplain
   * info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#HAVDALAH} item for a specific
   * date.
   *
   * @param items a list of {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.items.ResponseItem}.
   * @param shabbatDate the date object for looking up the {@linkplain
   *     info.tomfi.alexa.skills.shabbattimes.api.enums.ItemCategories#HAVDALAH} item.
   * @return an Optional {@link
   *     info.tomfi.alexa.skills.shabbattimes.api.response.items.ResponseItem} corresponding to the
   *     requested date.
   */
