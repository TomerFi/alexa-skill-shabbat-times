# Contributing to `alexa-skill-shabbat-times`</br>[![conventional-commits]][0]
...
-e VALIDATE_EDITORCONFIG=true -e VALIDATE_JAVA=true -e VALIDATE_JSON=true -e VALIDATE_MARKDOWN=true \
